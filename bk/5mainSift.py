...
# 处理所有图片对
for i in range(2):  # 图片范围从0000.jpg到0004.jpg
...
#     # 读取新视图
#     img_new = cv2.imread(os.path.join(img_dir, f"{i:04d}.jpg"))
#
#     # 检测关键点并计算描述子
...
#     descriptors_list.append(descriptors_new)
#
#     # 如果这不是第一个视图，就进行匹配、相机姿态估计和三角测量
#     if i > 0:
#
#         # ... #使用FLANN匹配器进行匹配，这里假设您已经定义了FLANN匹配器
#
#         # 进行PnP求解来估计相机姿态
#         # ...
#
